...
int main(int argc, char *argv[])
{
  ...
  // Install callback functions:
	...
	glGetDoublev(GL_PROJECTION, projMatrix);
	y = 0;
	cout<<"projMatrix after identity load: "<<endl;
	for( int x = 0; x<16; x++)
	{
		cout<<projMatrix[x]<<" ";
		y++;
	...
	y = 0;
	cout<<"projMatrix after frust load: "<<endl;
	for( int x = 0; x<16; x++)
	{
		cout<<projMatrix[x]<<" ";
		y++;
	...
	glGetDoublev(GL_MODELVIEW, projMatrix);
	...
	glGetDoublev(GL_MODELVIEW, projMatrix);
	y = 0;
	cout<<"projMatrix after modelMat load: "<<endl;
	for( int x = 0; x<16; x++)
	{
		cout<<projMatrix[x]<<" ";
		y++;
